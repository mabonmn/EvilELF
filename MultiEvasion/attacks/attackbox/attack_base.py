...
class Attack(object):
    ...
    def __init__(self, model_1, model_2):
        ...
        if self.model_name_2 == 'AvastNet_freezeEmbed':
            self.embed_matrix_2 = self.embed_2(torch.arange(0, 256).to(self.device))
        else:
    ...
    def _final_adv_x_selection(self, x=None, adv_x1=None, adv_x2=None, verbose=True, index_to_perturb=None,fast_version=True):
        """
