"""
FFGSM for models with different input format.
model_1: raw byte input format;
model_2: image input format
"""
import copy
...
class FFGSM(Attack_different_input):
    r"""
    ...
    def __init__(self,
        ...
        super(FFGSM,self).__init__(model_1 = model_1,
                                   model_2 = model_2,
                                   width = width,
                                   height = height)
    ...
    def perturbation(self,
        ...
        if self.model_2:
            ...
            ## get adv_x by applied with FGSM based perturbations
            ## by add pert on adv_x initiated with benign contents or random bytes
            adv_x2 = self._get_advImage_for_FFGSM(x=x_adv_init,
